...
<div class="col-md-8">
    <form action="/route" method="post">
        ...
        <div class="myrow">
            Departure date from:
            <input type="date" name="date" value="${d}" class="form-control" required/>
            Departure time from:
        ...
        <input type="submit" name="command" value="Select" class="btn btn-primary btn-lg"/>
        ...
        <c:if test="${not empty trains}">
            ...
            <table class="table">
                ...
                <c:forEach items="${trains}" var="train">
                    <tr>
                        ...
                        <td>${train.toDate}</td>
                        <td>
                            <select name="train${train.trainId}" class="form-control">
                                ...
                                <c:if test="${train.berthFree gt 0}">
                                    <option value="B">B (${train.berthFree}) = ${train.berthPrice} UAH</option>
                                </c:if>

                                <c:if test="${train.deluxeFree gt 0}">
                                    <option value="L">L (${train.deluxeFree}) = ${train.deluxePrice} UAH</option>
                                </c:if>
                            </select>
                        </td>
                    </tr>
            ...
            <input type="submit" name="command" value="Make tickets" class="btn btn-primary btn-lg"/>
        </c:if>
    </form>
</div>
<div class="col-md-2"></div>
